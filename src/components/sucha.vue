<template>
  <div class="card text-center">
    ...
    <div class="card-body">
      ...
      <a class="btn btn-outline-primary" target="_blank" href="https://www.haorooms.com/tools/css_selecter/">CSS选择器演示</a>
      ...
      <a class="btn btn-light" target="_blank" href="http://apps.eky.hk/css-triangle-generator/">CSS生成三角形</a>
